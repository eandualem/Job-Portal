...
class ComposerStaticInitc45b20cc4b57734fc6a0a1977f1c3d4c
{
    ...
    public static $classMap = array (
        ...
        'Auth' => __DIR__ . '/../..' . '/application/libs/Auth.php',
        'Controller' => __DIR__ . '/../..' . '/application/libs/Controller.php',
        'Database' => __DIR__ . '/../..' . '/application/libs/Database.php',
        'EmployeeModel' => __DIR__ . '/../..' . '/application/models/employee_model.php',
        'EmployerModel' => __DIR__ . '/../..' . '/application/models/employer_model.php',
        ...
        'Home' => __DIR__ . '/../..' . '/application/controllers/login/home.php',
        'LoginModel' => __DIR__ . '/../..' . '/application/models/login_model.php',
        ...
        'Session' => __DIR__ . '/../..' . '/application/libs/Session.php',
        ...
        'View' => __DIR__ . '/../..' . '/application/libs/View.php',
        'accept' => __DIR__ . '/../..' . '/application/controllers/employer/accept.php',
        'addVacancies' => __DIR__ . '/../..' . '/application/controllers/employer/addVacancies.php',
        'employee' => __DIR__ . '/../..' . '/application/controllers/employee/employee.php',
        'employer' => __DIR__ . '/../..' . '/application/controllers/employer/employer.php',
        'forgot' => __DIR__ . '/../..' . '/application/controllers/login/forgot.php',
        'former' => __DIR__ . '/../..' . '/application/controllers/employer/former.php',
        'login' => __DIR__ . '/../..' . '/application/controllers/login/login.php',
        'register' => __DIR__ . '/../..' . '/application/controllers/login/register.php',
        'register_employee' => __DIR__ . '/../..' . '/application/controllers/login/register_employee.php',
        'register_employer' => __DIR__ . '/../..' . '/application/controllers/login/register_employer.php',
        'search' => __DIR__ . '/../..' . '/application/controllers/employee/search.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitc45b20cc4b57734fc6a0a1977f1c3d4c::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitc45b20cc4b57734fc6a0a1977f1c3d4c::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInitc45b20cc4b57734fc6a0a1977f1c3d4c::$prefixesPsr0;
            $loader->classMap = ComposerStaticInitc45b20cc4b57734fc6a0a1977f1c3d4c::$classMap;
