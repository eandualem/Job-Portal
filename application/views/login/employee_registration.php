<div class="container createAccount">
    ...
    <form role="form" action="<?php echo URL; ?>register_employee/register" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" rows="3" name="AboutMe" required></textarea>
        </div>
